...
<body>
	...
	<div class="sidebar close">
		...
		<ul class="nav-links">
			...
			<li>
				<div class="iocn-link">
					<a href="#"> <i class='bx bxs-pointer' style='color:#c35deb' ></i> <span
	...
	<section class="home-section">
		<div class="home-content">
			<i class='bx bx-menu'></i> <span class="text">Sliding Window </span>
		</div>
		<table class="table">
			<thead>
				<tr>
			...
			<tbody>
				...
				List<Question> list = queDao.getQuestions("Sliding Window", userEmail);
