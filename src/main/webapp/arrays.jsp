...
<link href='https://unpkg.com/boxicons@2.0.7/css/boxicons.min.css'
	rel='stylesheet'>
<link rel="stylesheet" href="styles/styleQuestionPages.css">
...
<body>
	...
	<div class="sidebar close">
		...
		<ul class="nav-links">
			<li><a href="arrays.jsp"> <i class='bx bx-list-ol' style='color:#c35deb'></i>
	...
	<section class="home-section">
		...
		<table class="table">
			...
			<tbody>
				...
				List<Question> list = queDao.getQuestions("Arrays", userEmail);
