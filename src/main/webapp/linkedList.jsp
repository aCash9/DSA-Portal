...
<body>
	...
	<div class="sidebar close">
		...
		<ul class="nav-links">
			...
			<li>
				<div class="iocn-link">
					<a href="#"> <i class='bx bxl-stack-overflow'
						style='color: #c35deb'></i> <span class="link_name">Dynamic</span>
			...
			<li>
				<div class="iocn-link">
					<a href="#"> <i class='bx bxs-user-detail'></i> <span
						class="link_name">Your Lists</span>
					</a> <i class='bx bxs-chevron-down arrow'></i>
				</div>
				<ul class="sub-menu">
					...
					%>
					<li><a
						href="userListPage.jsp?listID=<%=d.getListID()%>&includeCompany=<%=d.getIncludeCompany()%>"><%=d.getListName()%></a></li>
					<%
					}
					if (flag) {
					%>
	...
	<section class="home-section">
		<div class="home-content">
			<i class='bx bx-menu'></i> <span class="text">Linked List </span>
		</div>
		<table class="table">
			<thead>
				<tr>
			...
			<tbody>
				...
				List<Question> list = queDao.getQuestions("Linked List", userEmail);
